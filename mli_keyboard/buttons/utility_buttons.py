...
from mli_keyboard.config import BACKSPACE_CLICKED_COUNT_1, BACKSPACE_CLICKED_COUNT_2, BACKSPACE_SPACE_SPEED_1, \
    BACKSPACE_SPACE_SPEED_2, BACKSPACE_SPACE_SPEED_3, BUTTON_X_OFFSET, BUTTON_Y_OFFSET, H_OFFSET, \
