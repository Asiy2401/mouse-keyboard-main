...
from PyQt5.QtWidgets import QGraphicsPolygonItem, QGraphicsTextItem, QGraphicsPixmapItem, QMenu
...
from mli_keyboard.config import  BACK_COLOR_ON_CLICK, BUTTON_Y_OFFSET, DEFAULT_SYMBOL, KEY_BORDER_COLOR, \
    KEY_BORDER_WIDTH, LETTER_FONT_FAMILY, LETTER_FONT_SIZE, PRESS_DELAY_DEFAULT, BACK_COLOR_LETTER, BACKLIGHT_COLOR
import pyautogui
