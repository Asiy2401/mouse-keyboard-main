...
# Конфигурации матриц
RU_MATRIX = [
    [AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, RussianLangEnum.H,
     RussianLangEnum.G, RussianLangEnum.EA, RussianLangEnum.YE, AuxiliaryKeysEnum.INVISIBLE,
     AuxiliaryKeysEnum.INVISIBLE],
    [AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.COMMA, RussianLangEnum.I_KRATKOE,
     RussianLangEnum.D, RussianLangEnum.M, RussianLangEnum.SHA, AuxiliaryKeysEnum.INVISIBLE,
     AuxiliaryKeysEnum.INVISIBLE],
    [AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, RussianLangEnum.ERY, RussianLangEnum.V,
     RussianLangEnum.O, RussianLangEnum.L, RussianLangEnum.YA, RussianLangEnum.U, AuxiliaryKeysEnum.INVISIBLE],
    [AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, RussianLangEnum.B, RussianLangEnum.P,
     AuxiliaryKeysEnum.INVISIBLE, RussianLangEnum.A, RussianLangEnum.S, AuxiliaryKeysEnum.INVISIBLE,
     AuxiliaryKeysEnum.INVISIBLE],
    [AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, RussianLangEnum.Y, RussianLangEnum.R,
     RussianLangEnum.E, RussianLangEnum.T, RussianLangEnum.SOFT_SIGN, RussianLangEnum.F, AuxiliaryKeysEnum.INVISIBLE],
    [AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, RussianLangEnum.TS, RussianLangEnum.J,
     RussianLangEnum.N, RussianLangEnum.I, RussianLangEnum.K, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE],
    [AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, RussianLangEnum.HARD_SIGN,
     RussianLangEnum.Z, RussianLangEnum.CH, RussianLangEnum.SH, AuxiliaryKeysEnum.INVISIBLE,
     AuxiliaryKeysEnum.INVISIBLE],
]

EN_MATRIX = [
    [AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, EnglishLangEnum.X,
     EnglishLangEnum.V, EnglishLangEnum.Z, AuxiliaryKeysEnum.QUESTION, AuxiliaryKeysEnum.INVISIBLE,
     AuxiliaryKeysEnum.INVISIBLE],
    [AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.COMMA, EnglishLangEnum.W,
     EnglishLangEnum.Y, EnglishLangEnum.L, AuxiliaryKeysEnum.DOT, AuxiliaryKeysEnum.INVISIBLE,
     AuxiliaryKeysEnum.INVISIBLE],
    [AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, EnglishLangEnum.H, EnglishLangEnum.A,
     EnglishLangEnum.E, EnglishLangEnum.R, EnglishLangEnum.B, AuxiliaryKeysEnum.SEMICOLON, AuxiliaryKeysEnum.INVISIBLE],
    [AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, EnglishLangEnum.C, EnglishLangEnum.T,
     AuxiliaryKeysEnum.INVISIBLE, EnglishLangEnum.I, EnglishLangEnum.D, AuxiliaryKeysEnum.INVISIBLE,
     AuxiliaryKeysEnum.INVISIBLE],
    [AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, EnglishLangEnum.M, EnglishLangEnum.S,
     EnglishLangEnum.O, EnglishLangEnum.N, EnglishLangEnum.K, AuxiliaryKeysEnum.COLON, AuxiliaryKeysEnum.INVISIBLE],
    [AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.EXCLAMATION,
...
SYM_MATRIX = [
    [AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, NumberEnum.ONE,
     NumberEnum.TWO, NumberEnum.THREE, NumberEnum.FOUR, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE],
    [AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, NumberEnum.FIVE, NumberEnum.SIX,
     NumberEnum.SEVEN, NumberEnum.EIGHT, NumberEnum.NINE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE],
    [AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.NUMERO_SIGN,
    ...
    [AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.SQUARE_LEFT_BRACKETS,
    ...
    [AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.CURLY_LEFT_BRACKETS,
    ...
    [AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.DOUBLE_QUOTATION,
    ...
    [AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.INVISIBLE, AuxiliaryKeysEnum.LOW_DASH,
...
UTILITY_BUTTONS_CONFIGS = {
    UtilityKeysEnum.SPACE: {'design': 'Пробел', 'font_size': 14, 'coord': (537.7777777777777, 293.3333333333333),
                            'sound_click_path': SOUND_CLICK_LETTER, 'back_color': BACK_COLOR_UTILITY, 'backlight_color': BACKLIGHT_COLOR_UTILITY},
    UtilityKeysEnum.BACKSPACE: {'design': '&lt; Back', 'font_size': 14,
                                'coord': (831.1111111111111, 146.66666666666666),
                                'sound_click_path': SOUND_CLICK_SPECIAL, 'back_color': BACK_COLOR_UTILITY, 'backlight_color': BACKLIGHT_COLOR_UTILITY},
    ...
    UtilityKeysEnum.SETTINGS: {'design': '⛯', 'font_size': 18, 'coord': (244.44444444444443, 146.66666666666666),
                               'sound_click_path': SOUND_CLICK_SPECIAL, 'back_color': BACK_COLOR_SETTINGS, 'backlight_color': BACKLIGHT_COLOR_SETTINGS, 'svg': True},
    UtilityKeysEnum.MOVE: {'design': '⇹', 'font_size': 24, 'coord': (293.3333333333333, 513.3333333333333),
                           'sound_click_path': SOUND_CLICK_SPECIAL, 'back_color': BACK_COLOR_SETTINGS, 'backlight_color': BACKLIGHT_COLOR_SETTINGS},
    ...
    UtilityKeysEnum.LEFT: {'design': '←', 'font_size': 14, 'coord': (146.66666666666666, 293.3333333333333),
                           'sound_click_path': SOUND_CLICK_SPECIAL, 'back_color': BACK_COLOR_ARROW, 'backlight_color': BACKLIGHT_COLOR_ARROW},
